...
###################################################################
N=19
rootDir="C:\\Users\\wu\\spyder_workspace\\HurryUp2\\TempData\\daten\\daten"
tempDataDir="C:\\Users\\wu\\spyder_workspace\\HurryUp2\\TempData\\clinical_variables.txt"
SUBJECTS=pd.read_csv(rootDir+"\\klinische_Variablen\\OVGU_FME_IMP_subjects_anonymized.csv")
#OPTOMETRY=pd.read_csv(rootDir+"\\klinische_Variablen\\O                                                                                                                                                                                                                                                                                                                                                            VGU_FME_IMP_optometry.csv")
OPTOMETRY=pd.read_csv(rootDir+"\\klinische_Variablen\\OVGU_FME_IMP_optometry_nan2k(3)-nn_eyes_wght.csv")
